    ...
    <div>
        {/* Part-1 fixed button */}
              <div className='flex justify-between gap-2 text-[20px] bg-white fixed bottom-0 w-full max-w-[768px] md:hidden pb-2 px-3  z-80'>
                ...
                <div onClick={()=>navigate('/RegisterLogin')} className='py-1.5 font-semibold'><div className='flex justify-center'><FaRegUser /></div><div className='text-[13px] flex justify-center'>Account</div></div>
