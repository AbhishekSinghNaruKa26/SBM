    ...
    <div className="my-20 sm:my-35 grid grid-cols-1 md:grid-cols-2 space-y-2 sm:flex sm:flex-row-reverse  max-w-[1500px] w-full mx-auto sm:gap-15 px-4">
      ...
      <div className=" space-y-1 md:space-y-10 md:max-w-[400px] w-full mx-auto">
        <div className="space-y-4 md:shadow-xl w-full py-4 px-2  sm:py-8 sm:px-4 rounded-md ">
          <h1 className="font-semibold text-[23px] sm:text-[28px]">
            Report a Safety Emergency
          </h1>
          <div className="text-[18px] sm:text-[22px] text-gray-600">
            We are committed to the safety of everyone using Zomato.
          </div>
          <button className="text-[25px] text-red-500">Report here</button>
        </div>
      ...
      <div className="max-w-[1100px] w-full mx-auto space-y-10 mt-4 sm:mt-0">
        ...
        <form className="space-y-10 w-full mx-auto">
          <input
            type="text"
            placeholder="Full Name"
            className="text-[20px] sm:text-[23px] border border-gray-400 text-gray-400 rounded-md py-3 px-4 w-full placeholder:text-[20px] placeholder:sm:text-[23px] placeholder:text-gray-400 tracking-widest"
          />
          <input
            type="email"
            placeholder="Email"
          ...
          <textarea
            ...
            className="text-[20px] sm:text-[23px] border border-gray-400 text-gray-400 rounded-md py-3 px-4 w-full placeholder:text-[20px] placeholder:sm:text-[23px] placeholder:text-gray-400 tracking-widest h-[200px]"
          ></textarea>
        </form>
