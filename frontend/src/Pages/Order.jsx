...
function Order() {
  ...
  return (
    <>
      <div className="bg-red-500 w-full mx-auto fixed top-0 left-0 flex justify-between items-center">
      ...
      <div className="w-full mx-auto my-15 sm:my-18 px-4 flex flex-col items-center space-y-5 sm:space-y-10">
        ...
        <div className="flex items-center gap-4 w-full mx-auto">
          ...
          <div className="truncate">
            <span className="text-[14px] md:text-[20px] text-gray-800">
              STAYFREE Dry-Max All Nights| All round protection through the
              night| 2x better coverage Sanitary Pad
            </span>
            <p className="text-[12px] md:text-[18px] text-gray-500">
              Pack of 42
            </p>
          </div>
        </div>
        ...
        <div className="w-full mx-auto">
          ...
          <div className=" bg-gray-100 px-4 py-4  rounded-md flex flex-col gap-4">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-3 ">
                ...
                <span className="text-[13px] sm:text-[16px] ">
                  {" "}
                  1-B-152 K.BH.B, Jodhpur District Rajasthan 342005
                </span>
              </div>
            ...
            <div className="border-b border-gray-200 mx-0 sm:mx-20 "></div>
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-3 ">
                <FaRegUser className="sm:text-[20px]" />
                <span className=" text-[15px] sm:text-[18px] font-bold">
                  Amar Singh
                </span>
                <span className="text-[13px] sm:text-[16px] ">9784247815</span>
              </div>
              <div className="text-[15px] sm:text-[18px]">
                <IoIosArrowForward />
              </div>
        ...
        <div className="w-full mx-auto flex items-center justify-center border border-red-400 rounded-md">
          <div
            className="text-[18px] sm:text-[22px] text-red-500 font-bold py-2 sm:py-4"
            onClick={() => navigate("/products")}
          >
            <button className="">Shop More From SBM</button>
          </div>
        </div>
      </div>
    </>
