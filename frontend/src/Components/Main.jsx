  ...
  return (
    <>
      <div className="max-w-[1400px]  w-full mb-24 mx-auto  mt-8">
        {/* Heading */}
        <div className="w-full max-w-[220px] whitespace-nowrap font-semibold mx-auto text-xl md:text-2xl">
          {" "}
          SBM Exclusive Collection{" "}
        </div>
        ...
        <div className="flex gap-7 mt-6 overflow-x-auto w-full mx-auto">
          {exclusiveProducts.map((product, index) => (
            <div
              key={index}
              className="px-3 border border-black min-w-48 max-w-48 whitespace-nowrap truncate rounded-lg mx-3 "
            >
              <div
                onClick={() => navigate("/products/cart")}
                className="flex justify-center my-2"
              >
                <img className="h-30 w-20" src={product.img} alt="" />
              </div>
              ...
              <div onClick={() => navigate("/products/cart")}>
                <span className="pr-2 text-[14px] line-through">
                  {product.orignal}
                </span>
              ...
              <div
                ...
                className=" my-2 rounded-lg text-white flex justify-center"
              >
                <button
                  className="group relative bg-black rounded-lg py-1 w-full "
