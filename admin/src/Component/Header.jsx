  ...
  return (
    ...
    <div className="bg-red-500 max-w-[350px] h-screen fixed w-full  top-0 left-0 text-white p-3">
      ...
      <div className="p-2 mt-10 space-y-7 font-semibold">
        ...
        <div onClick={()=>{setSelected(item.name); setOpen(!open)}} key={index} className={`flex items-center gap-2 rounded p-2 text-xl ${selected===item.name ? `bg-gray-200 text-red-600  `:  ""}`}>
